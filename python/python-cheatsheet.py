...
#from __future__ import print_function # This to allow the printing without new lines
import random
import sys
import os
...
# Reverse list
print ("reversed list", grocery_list[::-1])
...
# Returns the number 'a' appears in the string
print (long_string.count('a'))
